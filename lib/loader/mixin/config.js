  ...
  loadConfig() {
    ...
    for (const filename of this.getTypeFiles('config')) {
      ...
      for (const unit of this.getLoadUnits()) {
        ...
        // preload config, so other plugin can use this meta info
        ...
        // :bm, 数组的middleware 直接全部重置?
        // run a deep clone, array with same index will be override
        // what can you say, a custom clone that uses comman name `extend`!
